...
namespace track_editor2
{
    public partial class TrackAssetPlayer2 : MonoBehaviour
    {
        ...
        public delegate void OnPlayEnd(TrackAssetPlayer2 player);
        public delegate void OnPlayStart(TrackAssetPlayer2 player);
        ...
        public void Play(TrackAsset2 asset)
        {
            this.asset = asset;
        ...
        public abstract class PlayerTrackBase
        {
            ...
            public virtual void OnTrackInitialize(TrackAssetPlayer2 player) { }
            public virtual void OnTrackStart(TrackAssetPlayer2 player) { }
            public virtual void OnTrackEnd(TrackAssetPlayer2 player) { }
        }
        ...
        public abstract class PlayerElementBase
        {
            ...
            public virtual void OnElementStart(TrackAssetPlayer2 player) { }
            public virtual void OnElementEnd(TrackAssetPlayer2 player) { }
        }
    }
}
